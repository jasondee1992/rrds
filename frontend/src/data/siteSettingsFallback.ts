...
export const fallbackFounderImage = founderPlaceholder;

export const fallbackSiteSettings: SiteSettings = {
  company: {
    name: "RRDS Airconditioning Services",
    contactNumber: "0947 476 8214",
    email: "oneal101982@gmail.com",
    address:
      "#420 B Senator Neptali A. Gonzales St. Brgy. San Jose Sitio 4, Mandaluyong, Philippines, 1550",
  },
  socialLinks: {
    facebook: "https://www.facebook.com/RRDSAirconServices",
  },
  founder: {
